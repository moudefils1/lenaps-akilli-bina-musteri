...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>@yield("title") Lenaps IoT Platformu</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <span class="nxl-mtext">Panel Yönetimi</span><span class="nxl-arrow"><i
                                class="feather-chevron-right"></i></span>
                    </a>
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="{{route("admin.users.index")}}">Kullanıcılar</a>
                        </li>
                        <li class="nxl-item"><a class="nxl-link"
                                                href="{{route("admin.role-permissions.index")}}">Roller</a></li>
                    </ul>
                </li>
                {{--<li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
    ...
    <div class="header-wrapper">
        ...
        <div class="header-right ms-auto">
            <div class="d-flex align-items-center">
                ...
                <div class="nxl-h-item me-3 dark-light-theme">

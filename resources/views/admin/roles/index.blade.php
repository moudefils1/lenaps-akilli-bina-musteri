        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <!--begin::Add product-->
                    {{--<a href="{{route("admin.role-permissions.create")}}" class="btn btn-primary">Ekle</a>--}}
                    <a href="{{route("admin.role-permissions.create")}}" class="btn btn-sm btn-flex btn-light-primary">
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                    ...
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-start min-w-200px">Rol Adı</th>
                        <th class="text-start min-w-100px">Yetkileri</th>
                        <th class="text-start min-w-100px">Kullanıcıları</th>
                    ...
                    @foreach($rolesWithUsers as $roleWithUsers)
                        <tr>
                            <td>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="">
                                        ...
                                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name"
                                           data-bs-toggle="modal" data-bs-target="#kt_modal_update_role_{{$loop->iteration}}">
                                            {{$roleWithUsers["role"]->name}}
                                        </a>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            ...
                            <td class="text-start pe-0">
                                <span class="">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_update_role_{{$loop->iteration}}"
                                       class="btn btn-sm btn-flex btn-light-success">
                                        <i class="ki-outline ki-shield-tick fs-3"></i> Yetkiler
                                    </a>
                                </span>
                            </td>
                            <td class="text-start pe-0">
                                <span class="">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_role_users_{{$loop->iteration}}"
                                       class="btn btn-sm btn-flex btn-light-primary">
                                        <i class="ki-outline ki-people fs-3"></i> Kullanıcılar
                                    </a>
                                </span>
                            </td>
                            <td class="text-start pe-0">
                                <span class="fw-bold">{{$roleWithUsers["role"]->created_at}}</span>
                            </td>
                            <td class="text-start pe-0">
                                <span class="fw-bold">{{$roleWithUsers["role"]->updated_at}}</span>
                            </td>
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        <a href="{{route("admin.role-permissions.edit", $roleWithUsers["role"]->name)}}" class="menu-link px-3">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-center">
                                        ...
                                        <form action="{{route("admin.role-permissions.destroy", $roleWithUsers["role"]->id)}}" method="post">
                                            @csrf
                                            @method("DELETE")
                        ...
                        <div class="modal fade" id="kt_modal_update_role_{{$loop->iteration}}" role="dialog" tabindex="-1" aria-hidden="true">
                            <!--begin::Modal dialog-->
                            <div class="modal-dialog modal-dialog-centered mw-750px">
                                ...
                                <div class="modal-content">
                                                            ...
                                                            <div class="d-flex mb-2 ms-4">
                                                                ...
                                                                <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20 ms-4">
                                                                    <input class="form-check-input permissions" type="checkbox" name="permissions[]"
                                                                           @checked($roleWithUsers["role"]->hasPermissionTo("view_" . $permission->name()))
                                                                ...
                                                                <label class="form-check form-check-custom form-check-solid me-5 me-lg-20">
                                                                    <input class="form-check-input permissions" type="checkbox" name="permissions[]"
                                                                           @checked($roleWithUsers["role"]->hasPermissionTo("create_" . $permission->name()))
                                                                ...
                                                                <label class="form-check form-check-custom form-check-solid me-5 me-lg-20">
                                                                    <input class="form-check-input permissions" type="checkbox" name="permissions[]"
                                                                           @checked($roleWithUsers["role"]->hasPermissionTo("update_" . $permission->name()))
                                                                ...
                                                                <label class="form-check form-check-custom form-check-solid">
                                                                    <input class="form-check-input permissions" type="checkbox" name="permissions[]"
                                                                           @checked($roleWithUsers["role"]->hasPermissionTo("delete_" . $permission->name()))
                                    ...
                                    <div class="modal-footer justify-content-center">
                                        <a href="{{route("admin.role-permissions.edit", $roleWithUsers["role"]->name)}}" class="btn btn-sm btn-flex btn-light-primary">

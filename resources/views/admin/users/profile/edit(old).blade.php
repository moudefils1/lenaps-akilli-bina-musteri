...
@section("title")
    Güncelle | Profilim | Akıllı Hastane Yönetim Sistemi
@endsection
@section('styles')
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label">@if($user->id == 1) Yetki @else Rol @endif</label>
                                        <!--end::Label-->
                                        <!--begin::Select2-->
                                        @if($user->id ==1)
                                            <input class="form-control mb-2 text-bg-secondary" placeholder="Tam Yetki" readonly>
                                        @else
                        ...
                        <div class="mb-10 fv-row">
                            <!--begin::Label-->
                            <label class="required form-label" for="keywords">Nom et Prénoms</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name"
                                   class="form-control mb-2 @error('name') is-invalid @enderror"
                                   placeholder="Saisissez le nom et le prénom de l'utilisateur" value="{{old('name', $user->name)}}"/>
                            <!--end::Input-->
                            <!--begin::Description-->
                            @error('name')
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">Téléphone</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" name="phone"
                                           class="form-control mb-2 @error("phone") is-valid @enderror" max="99999999999"
                                           placeholder="Saisissez le numéro de téléphone" value="{{old("phone", $user->phone)}}"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    @error('phone')
                        ...
                        <div>
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea name="address" id="kt_docs_tinymce_basic" placeholder="Saisissez l'adresse"
